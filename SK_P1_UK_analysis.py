...
def animate_single_file(filename, frac=0.1, Nbins=100, remove_frames=True, do_tqdm=False, plot_first_day=False):
    ...
    it = range(0, len(SIRfile_SK), int(len(SIRfile_SK)*frac))
    if do_tqdm:
