...
with PdfPages(pdf_name) as pdf:
    ...
    for bw in tqdm([0.1, 0.01, 0.001, 0.0005, 0.0001]):
        ...
        #%%
        kde = KernelDensity(kernel='gaussian', bandwidth=bw, metric='haversine').fit(P1_org) # 
...
kde_out = KernelDensity(kernel='gaussian', bandwidth=bw, metric='haversine').fit(P1_org) # 
