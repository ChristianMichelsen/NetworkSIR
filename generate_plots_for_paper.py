...
filename_hdf5_spatial = "Data/network/v__1.0__N_tot__5800000__rho__0.1__epsilon_rho__0.04__mu__40.0__sigma_mu__0.0__beta__0.01__sigma_beta__0.0__algo__2__N_init__100__lambda_E__1.0__lambda_I__1.0__make_random_initial_infections__1__N_connect_retries__0__ID__0.hdf5"
...
fig_ABM_vanilla.savefig("Figures/Paper/Figure_2_ABM_vanilla.pdf", dpi=100)

plot.plot_1D_scan(scan_parameter="mu", figname_pdf="Figures/Paper/Figure_2_1D_scan_mu.pdf")
plot.plot_1D_scan(scan_parameter="beta", figname_pdf="Figures/Paper/Figure_2_1D_scan_beta.pdf")

#%%

reload(generate_animations)
fig_coordinates_vanilla, _ = generate_animations.make_paper_screenshot(
    filename_hdf5_vanilla, title="5.80M, vanilla", i_day=50
)

fig_coordinates_vanilla.savefig("Figures/Paper/Figure_2_coordinates_vanilla.pdf", dpi=100)

fig_coordinates_spatial, _ = generate_animations.make_paper_screenshot(
    filename_hdf5_spatial, title="5.8Mk, spatial", i_day=20
)

fig_coordinates_spatial.savefig("Figures/Paper/Figure_2_coordinates_spatial.pdf", dpi=100)
...
fig_ABM_spatial.savefig("Figures/Paper/Figure_3_ABM_spatial.pdf", dpi=100)

plot.plot_1D_scan(scan_parameter="rho", figname_pdf="Figures/Paper/Figure_3_1D_scan_rho.pdf")
plot.plot_1D_scan(
    scan_parameter="epsilon_rho",
    non_default_parameters=dict(rho=0.1),
    figname_pdf="Figures/Paper/Figure_3_1D_scan_epsilon_rho.pdf",
)
...
fig_contacts_vanilla.savefig("Figures/Paper/Figure_3_contacts_vanilla.pdf", dpi=100)
...
fig_contacts_spatial.savefig("Figures/Paper/Figure_3_contacts_spatial.pdf", dpi=100)
...
fig_plots_vanilla.savefig("Figures/Paper/Figure_4_fits_vanilla.pdf", dpi=100)

fig_plots_spatial, _ = plot.plot_single_fit(
    ABM_parameter_spatial, all_fits, add_top_text=False, xlim=(0, 210)
)
fig_plots_spatial.savefig("Figures/Paper/Figure_4_fits_spatial.pdf", dpi=100)


plot.plot_1D_scan_fit_results(
    all_fits, scan_parameter="rho", figname_pdf="Figures/Paper/Figure_4_1D_scan_fit_rho.pdf"
)
...
plot.plot_1D_scan_fit_results(
    ...
    scan_parameter="epsilon_rho",
    non_default_parameters=dict(rho=0.1),
    figname_pdf="Figures/Paper/Figure_4_1D_scan_fit_epsilon_rho.pdf",
)
