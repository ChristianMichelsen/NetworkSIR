...
@njit
def make_initial_infections(N_init, my_state, state_total_counts, agents_in_state, csMov, my_connections, my_number_of_contacts, my_rates, SIR_transition_rates, ages_in_state, initial_ages_exposed, cs_move_individual, N_infectious_states, coordinates):
            ...
            for idx_H_state in range(len(H_agents_in_state[H_old_state])):
                ...
                if Csum > ra1:
                    ...
                    if H_old_state < H_new_state:
                        ...
                        H_cumsum_move[H_new_state:] += H_move_matrix_sum[H_new_state, my_age[agent]] - H_move_matrix_sum[H_old_state, my_age[agent]]
...
class Simulation:
    ...
    def _save_network_initalization(self, my_age, my_infection_weight, my_number_of_contacts, my_connections, time_elapsed):
    ...
    def _load_network_initalization(self):
        ...
        return my_age, my_infection_weight, my_number_of_contacts, ak.from_awkward0(my_connections)
    ...
    def initialize_network(self, force_rerun=False, save_initial_network=True):
        ...
        if OSError_flag or force_rerun:
            ...
            my_connections, my_number_of_contacts = utils.nested_list_to_awkward_array(my_connections, return_lengths=True, sort_nested_list=True)
